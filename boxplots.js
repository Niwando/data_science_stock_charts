...
document.addEventListener('DOMContentLoaded', function(e) {
    ...
    // set the dimensions and margins of the graph (BARCHART)
    ...
    // append the svg object to the body of the page (BARCHART)
    ...
    // Create the boxplots variable: where both the rectangles and the lines take place
